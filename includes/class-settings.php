...
class Settings
{
    ...
    public function render_url_field(): void
    {
        ...
        // FIX #1: Używamy get_privacy_policy_url() zamiast get_the_privacy_policy_link()
        // get_the_privacy_policy_link() zwraca pełny HTML <a>, a my potrzebujemy tylko URL
        $default_url = function_exists('get_privacy_policy_url') ? get_privacy_policy_url() : '';
     ...
     * FIX #1: Zwracamy czysty URL, nie HTML z linkiem
     *
    ...
    public function get_privacy_url(): string
    {
        ...
        // FIX: get_privacy_policy_url() zwraca sam URL, nie cały tag <a>
        $default_url = function_exists('get_privacy_policy_url') ? get_privacy_policy_url() : '';

        return !empty($default_url) ? esc_url_raw($default_url) : '#';
    }
