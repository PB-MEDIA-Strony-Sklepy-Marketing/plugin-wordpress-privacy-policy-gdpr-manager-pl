...
class Assets
{
     ...
     * FIX: Dodano sanitize_url dla bezpieczeństwa przy lokalizacji skryptu
     */
    private function enqueue_config_script(): void
    {
        ...
        // FIX: Sanitizacja danych przed przekazaniem do JS
        $config_data = [
            'privacyUrl' => esc_url_raw($this->settings->get_privacy_url()),
            'contactEmail' => sanitize_email($this->settings->get_contact_email()),
            'pluginsUrl' => esc_url_raw($asset_url . 'js/'),
        ];
